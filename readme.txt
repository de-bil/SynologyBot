...
В самом боте Аватарка справа сверху -> Интеграция -> Боты (создать если нет). Исходящим URL является ip сервера где будет хотстится бот и порт 5000 (например http://192.168.25.234:5000/webhook)). 
